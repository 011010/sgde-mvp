    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="text-2xl font-bold">SGI</span>
        </Link>

        <div className="space-y-8">
          <div>
            <h1 className="text-4xl font-bold leading-tight">
              Únete a las instituciones educativas que ya usan SGI
            </h1>
        ...
        <p className="text-sm text-primary-foreground/60">
          &copy; {new Date().getFullYear()} SGI — Sistema de Gestión Integral
        </p>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-background p-6 lg:p-12">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="flex flex-col items-center text-center lg:hidden">
            ...
            <h1 className="text-2xl font-bold">SGI</h1>
